...
var file_user_proto_depIdxs = []int32{
	...
	4,  // 9: user.UserService.ListUser:input_type -> user.ListUserRequest
	...
	5,  // 17: user.UserService.ListUser:output_type -> user.ListUserResponse
